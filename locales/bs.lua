...
Locales['bs'] = {
    ...
    ['dealer.orderConfirmed']   = "Ni riječi više. Donesi keš za %s i idi na lokaciju koju ću ti uskoro poslati.",
    ['dealer.orderExpired']     = "Predugo je trajalo. Dogovor otpada.",
    ['dealer.dropLabel']        = 'Mjesto predaje',
    ['dealer.dropBody']         = "Evo. Ne zadržavaj se.",
