...
Locales['sr'] = {
    ...
    ['dealer.alreadyHaveOrder'] = "Već imaš nešto na putu. Prvo to reši.",
    ...
    ['dealer.orderConfirmed']   = "Ni reči više. Donesi keš za %s i idi na lokaciju koju ću ti uskoro poslati.",
    ['dealer.orderExpired']     = "Predugo je trajalo. Dogovor otpada.",
    ['dealer.dropLabel']        = 'Mesto predaje',
    ...
    ['collect.target']     = 'Preuzmi porudžbinu',
    ['collect.success']    = 'Zadovoljstvo je poslovati s tobom.',
    ['collect.failed']     = 'Neuspešno',
    ...
    ['ui.noteHeading']     = 'Išarana beleška',
}
